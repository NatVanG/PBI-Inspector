...
{
    internal class PbipReportFile : PbiFile, IDisposable
    {
        private bool disposedValue;
        private Stream _fileStream;

        public PbipReportFile(string pbiFilePath) : base(pbiFilePath)
        {
        }
        ...
        public override Stream GetEntryStream(string entryPath)
        {
            ...
            var filePath = Path.Combine(this.FilePath, entryPath);
